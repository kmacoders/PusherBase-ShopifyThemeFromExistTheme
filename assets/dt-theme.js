...
theme.brandLogos = (function() {
	function brandLogos(container) {
		var $container = this.$container = $(container);
		dT_Swiper($container);
	}
	return brandLogos;
...
theme.promoBlocks = (function() {
	function promoBlocks(container) {
		var $container = this.$container = $(container);
		dT_Swiper($container);
	}
	return promoBlocks;
...
theme.productSidebarCarousel = (function() {
	function productSidebarCarousel(container) {
		var $container = this.$container = $(container),
			sectionId = "product-sidebar-carousel-section";
		dT_Swiper($container);
		dt_initQuickShop(sectionId);
		dt_activateQuickShop();
	}
	return productSidebarCarousel;
})();
...
theme.ProductPage = (function() {
	...
	Product.prototype = _.assignIn({}, Product.prototype, {
		...
		_initProductStatus: function() {
			this.ProductStatus = new theme.ProductStatus(
			...
			if (variant) {
				...
				if (variant.compare_at_price > variant.price) {
					$(this.settings.selectors.comparePrice)
						.html(Shopify.formatMoney(variant.compare_at_price, DT_THEME.moneyFormat))
						.removeClass('hide');
...
$(document).ready(function() {
	...
	sections.register('brand-logos-section', theme.brandLogos);
	sections.register('about-brand-logos-section', theme.brandLogos);
	sections.register('home-image-gallery', theme.imageGallery);
	//  sections.register('testimonials-section', theme.testimonials);
	sections.register('about-testimonials-section', theme.testimonials);
	sections.register('featured-collection-section', theme.featuredCollection);
	sections.register('featured-blog-section', theme.featuredblog);
	...
	sections.register('product-sidebar-carousel-section', theme.productSidebarCarousel);
	...
	sections.register('promo-block-section', theme.promoBlocks);
...
/* if ($('.parallax-initiated').length ) {
if ($('.parallax-initiated').data('speed') == '2') {      
...
console.log("funtion dt_sc_parallax not initialized");
}*/
